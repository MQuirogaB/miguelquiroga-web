...
bloque: "Cambios químicos (+2 más)"
tipo: "Laboratorio (+1 más)"
---

## Introducción

¿Alguna vez has querido escribir un mensaje secreto que solo tú puedas leer? Con la cúrcuma, puedes hacerlo.

La cúrcuma es una especia que se utiliza en la cocina de muchas culturas del mundo y en esta actividad vamos a aprender a utilizarla como indicador de pH para crear tinta invisible.

## Objetivos

- Comprender el concepto de pH.
- Aprender a utilizar la cúrcuma como indicador de pH.
- Crear tinta invisible utilizando la cúrcuma.
...
La cúrcuma es un pigmento amarillo que se encuentra en la raíz de la planta Curcuma longa. La cúrcuma es soluble en alcohol, pero no en agua.
...
[Experiencias sorprendentes de química con indicadores de pH caseros](https://revistas.uca.es/index.php/eureka/article/view/3884) — En este trabajo se describen varias experiencias sencillas relacionadas con las reacciones ácido-base, realizables con utensilios de cocina y sustancias baratas, enfocadas a alumnos de enseñanza secundaria.
